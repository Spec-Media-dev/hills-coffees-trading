...
| 010 | Operations / Admin Console | `/dashboard-admin` | **Run 0 reconciled — implementation not started.** RUN A (T001–T006) is safe without a DB change; 009's warehouse contract is live, while 008 finance actions and 012 dispute/audit domain layers remain blockers for their bounded areas. | [spec](../../specs/010-admin-operations-console/spec.md) · [plan](../../specs/010-admin-operations-console/plan.md) · [tasks](../../specs/010-admin-operations-console/tasks.md) |
