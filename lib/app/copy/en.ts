    ...
    admin: {
      ...
      catalogue: {
        ...
        coffees: {
          ...
          media: {
            heading: "Media",
            lead: "Media records linked to this coffee, exactly as stored. The primary image and ordering can be managed; files themselves cannot be uploaded yet.",
            ...
            uploadUnavailableTitle: "Image upload is not available yet",
            uploadUnavailableDescription:
              "No approved public media storage exists: the only Storage bucket in the approved schema is the private KYB evidence bucket, and no catalogue bucket, Storage policy or metadata seam has been approved (recorded as DB-BLOCK-01 for public media). The public site shows a placeholder until this capability is approved. Nothing here simulates an upload.",
          },
        },
        origins: {
          title: "Origins",
        ...
        media: {
          title: "Media",
          description: "Media records across the catalogue, exactly as stored. Records are managed from each coffee's detail page; file upload is not available (DB-BLOCK-01).",
          breadcrumb: "Media",
